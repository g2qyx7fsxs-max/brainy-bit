...
relatedBooks:
  - title: "Rock, Brock, and the Savings Shock"
    author: "Sheila Bair"
relatedEvents:
  - name: "National Teach Children to Save Day (United States)"
    description: "A yearly event (usually in April) where U.S. banks send volunteers into classrooms to talk about saving money."
relatedFigures:
  - name: "Warren Buffett"
    description: "Legendary investor who famously calls compound interest 'the eighth wonder of the world.'"
quiz:
